...
class View(wx.Frame):
    def __init__(self, parent, subs=[], size=(1200,730)):
        ...
        self.deliver_lab = wx.StaticText(self.panel_top2, label='Deliver trial: ', style=wx.ALIGN_RIGHT)
        self.deliver_but = wx.Button(self.panel_top2, label='DELIVER')
        self.roi_lab = wx.StaticText(self.panel_top2, label='Select ROI: ', style=wx.ALIGN_RIGHT)
        self.roi_but = wx.Button(self.panel_top2, label='ROI')
        ...
        self.panel_top2_sizer.Add(self.deliver_lab, flag=wx.ALIGN_RIGHT, proportion=1)
        self.panel_top2_sizer.Add(self.deliver_but, proportion=1)
